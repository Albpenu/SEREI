...
![Imagen](http://img00.deviantart.net/eb3d/i/2012/268/c/6/http_blue_background_by_soulart2012-d5fu5n2.jpg)
---
...
### Típica Sesión HTTP
<p style="font-size: 30px; text-align: left;">En protocolos cliente-servidor, como HTTP, las sesiones consisten en <b><u>3 fases:</p>
<ol>
...
---
### Cookies HTTP
<p style="font-size: 40px; text-align: left;">Las cookies se utilizan principalmente con tres propósitos:
